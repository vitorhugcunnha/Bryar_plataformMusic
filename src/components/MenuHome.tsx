  ...
  return (
    ...
    >
      <div className="flex items-center justify-center gap-10">
        <div>
          <h1 className="pl-1.5 text-white font-bold text-3xl">
            Seja Bem-vindo Bryar
          </h1>
          <h2 className="text-white pl-1.5 font-bold text-2xl pt-5">
            Melhor plataforma de
          </h2>
          <h2 className="text-white pl-1.5 font-bold text-2xl">
            música atualmente
          </h2>
        ...
        <div className="p-16 bg-gradient-to-r from-[#990000] via-[#98465f] to-yellow-400 border-white border-2">
          <img src="src/assets/images/logoBryar.png" alt="Logo Bryar" />
        </div>
      </div>
    </div>
  );
